        ...
        <View style={styles.container}>
            ...
            <View style={{ marginTop: 20, flexDirection: 'row', justifyContent: 'center' }}>
                <TouchableOpacity style={{ justifyContent: 'center', alignItems: 'center' }}>
                    <View style={{ backgroundColor: '#87cefa', height: 45, width: 260, justifyContent: 'center', borderRadius: 50, alignItems: 'center', flexDirection: 'row' }}>
                        <Icon2 name="message1" size={25} color={'blue'} />
                        <Text style={{ fontSize: 17, fontWeight: 'bold', color: 'blue', marginLeft: 10 }}>Nhắn tin</Text>
                    </View>
                </TouchableOpacity>
                <TouchableOpacity style={{ justifyContent: 'center', alignItems: 'center', marginLeft: 15 }}>
                    <View style={{ backgroundColor: '#f0f8ff', height: 45, width: 60, justifyContent: 'center', borderRadius: 30, alignItems: 'center', flexDirection: 'row' }}>
...
export default TrangCaNhanKetBan;