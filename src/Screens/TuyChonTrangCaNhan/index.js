...
const TuyChonTrangCaNhan = ({route}) => {
    ...
    return (
        <View style={styles.container}>
            ...
            <View style={{marginTop:10,marginLeft:20}}>
                <TouchableOpacity onPress={() => navigation.navigate("ThongTinCaNhan",{user:route.params.user})}>
                    <Text style={{fontSize:17}}>Thông tin</Text>
                </TouchableOpacity>
                <View style={{ height: 1, backgroundColor: '#e6e6fa', marginTop: 10 }}></View>
                <TouchableOpacity style={{marginTop:10}}>
                    <Text style={{fontSize:17}}>Cập nhật hình đại diện</Text>
                </TouchableOpacity>
                <View style={{ height: 1, backgroundColor: '#e6e6fa', marginTop: 10 }}></View>
                <TouchableOpacity style={{marginTop:10}}>
                    <Text style={{fontSize:17}}>Cập nhật ảnh bìa</Text>
                </TouchableOpacity>
                <View style={{ height: 1, backgroundColor: '#e6e6fa', marginTop: 10 }}></View>
                <TouchableOpacity style={{marginTop:10}}>
                    <Text style={{fontSize:17}}>Cập nhật giới thiệu bản thân</Text>
                </TouchableOpacity>
                <View style={{ height: 2, backgroundColor: '#e6e6fa', marginTop: 10 }}></View>
                <TouchableOpacity style={{marginTop:10}}>
                    <Text style={{fontSize:17}}>Ví của tôi</Text>
                </TouchableOpacity>
            </View>
        </View>
    );
...
export default TuyChonTrangCaNhan;